...
Ledgence accepts CloudEvents 1.0 structured JSON. The worker receives a complete invocation envelope generated by its caller. The Rust orchestration service and PostgreSQL adapter generate and persist platform identities and invocation events; worker transport integration remains future work. The local fixture command creates example IDs for development.
